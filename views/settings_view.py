...
def create_setting_view(app_model: AppDataModel) -> object:
    return dcc.Tab(id="settings", className='tab',selected_className='tab--selected',label="Settings",
...
def create_tissue_settings(app_model: AppDataModel) -> object:
    return dcc.Tab(
        id="tissue_settings",
        label="Tissue",className='tab',selected_className='tab--selected',
        children=[
            html.Div(className='tissue_settings',children=[
            dcc.Dropdown(list([app_model.builtin_tissues[tissue]["name"] for tissue in app_model.builtin_tissues]),
                         id="tissue_select", value=app_model.tissue.name, style={'margin-top':'20px', 'margin-bottom':'20px'}),
            ...
            html.Div(id="optical_parameters",
                     children=[
                         ...
                         dcc.Input(id="wave_length", type="number", debounce=True,
                                   ...
                                   value=app_model.tissue.wave_length, style={'margin':'20px 0px 20px 5px', 'padding':'0px 5px'}),
                         ...
                         html.Div(id="native",
                                  children=[
                                      ...
                                      dcc.Input(id="native_refractive_index", type="number", debounce=True,
                                                ...
                                                value=app_model.tissue.native_refractive_index, style={'margin':'20px 0px 20px 5px', 'padding':'0px 5px'}),
                                      html.Label("Absorption: ", htmlFor="native_absorption", style={'margin-left':'10px'}),
                                      dcc.Input(id="native_absorption", type="number", debounce=True,
                                                ...
                                                value=app_model.tissue.native_absorption, style={'margin':'20px 0px 20px 5px', 'padding':'0px 5px'}),
                                      html.Label(" 1/mm", htmlFor="native_absorption"),
                                      html.Label("Scattering: ", htmlFor="native_scattering", style={'margin-left':'10px'}),
                                      dcc.Input(id="native_scattering", type="number", debounce=True,
                                                ...
                                                value=app_model.tissue.native_scattering, style={'margin':'20px 0px 20px 5px', 'padding':'0px 5px'}),
                                      html.Label(" 1/mm", htmlFor="native_scattering"),
                                      html.Label("G-factor: ", htmlFor="native_g_factor", style={'margin-left':'10px'}),
                                      dcc.Input(id="native_g_factor", type="number", debounce=True,
                                                ...
                                                value=app_model.tissue.native_g_factor, style={'margin':'20px 0px 20px 5px', 'padding':'0px 5px'}),
                                  ]),
                         ...
                         html.Div(id="coagulated",
                                  children=[
                                      ...
                                      dcc.Input(id="coagulated_refractive_index", type="number", debounce=True,
                                                ...
                                                value=app_model.tissue.coagulated_refractive_index, style={'margin':'20px 0px 20px 5px', 'padding':'0px 5px'}),
                                      html.Label("Absorption: ", htmlFor="coagulated_absorption", style={'margin-left':'10px'}),
                                      dcc.Input(id="coagulated_absorption", type="number", debounce=True,
                                                ...
                                                value=app_model.tissue.coagulated_absorption, style={'margin':'20px 0px 20px 5px', 'padding':'0px 5px'}),
                                      html.Label(" 1/mm", htmlFor="coagulated_absorption"),
                                      html.Label("Scattering: ", htmlFor="coagulated_scattering", style={'margin-left':'10px'}),
                                      dcc.Input(id="coagulated_scattering", type="number", debounce=True,
                                                ...
                                                value=app_model.tissue.coagulated_scattering, style={'margin':'20px 0px 20px 5px', 'padding':'0px 5px'}),
                                      html.Label(" 1/mm", htmlFor="coagulated_scattering"),
                                      html.Label("G-factor: ", htmlFor="coagulated_g_factor", style={'margin-left':'10px'}),
                                      dcc.Input(id="coagulated_g_factor", type="number", debounce=True,
                                                ...
                                                value=app_model.tissue.coagulated_g_factor, style={'margin':'20px 0px 20px 5px', 'padding':'0px 5px'}),
                                  ]),
            ]),
            html.Br(),
            ...
            html.Div(id="thermal_parameters",
                     children=[
                         ...
                         dcc.Input(id="initial_temperature", type="number", debounce=True,
                                   ...
                                   value=app_model.tissue.initial_temperature, style={'margin':'20px 0px 20px 5px', 'padding':'0px 5px'}),
                         html.Label(" ^C", htmlFor="initial_temperature"),
                         html.Label("Blood perfusion: ", htmlFor="blood_perfusion", style={'margin-left':'10px'}),
                         dcc.Input(id="blood_perfusion", type="number", debounce=True,
                                   ...
                                   value=app_model.tissue.blood_perfusion, style={'margin':'20px 0px 20px 5px', 'padding':'0px 5px'}),
                         html.Label(" ml/(g min)", htmlFor="blood_perfusion"),
                         html.Label("Water content: ", htmlFor="water_content", style={'margin-left':'10px'}),
                         dcc.Input(id="water_content", type="number", debounce=True,
                                   ...
                                   value=app_model.tissue.water_content, style={'margin':'20px 0px 20px 5px', 'padding':'0px 5px'}),
                         html.Label(" %", htmlFor="water_content"),
                         html.Label("Heat conductivity: ", htmlFor="heat_conductivity", style={'margin-left':'10px'}),
                         dcc.Input(id="heat_conductivity", type="number", debounce=True,
                                   ...
                                   value=app_model.tissue.heat_conductivity, style={'margin':'20px 0px 20px 5px', 'padding':'0px 5px'}),
                         html.Label(" W/(cm K)", htmlFor="heat_conductivity"),
                         html.Label("Heat capacity: ", htmlFor="heat_capacity", style={'margin-left':'10px'}),
                         dcc.Input(id="heat_capacity", type="number", debounce=True,
                                   ...
                                   value=app_model.tissue.heat_capacity, style={'margin':'20px 0px 20px 5px', 'padding':'0px 5px'}),
                         ...
                         dcc.Input(id="density", type="number", debounce=True,
                                   ...
                                   value=app_model.tissue.density, style={'margin':'20px 0px 20px 5px', 'padding':'0px 5px'}),
            ...
            html.Div(id="damage_parameters",
                     children=[
                         ...
                         dcc.Input(id="damage_threshold", type="number", debounce=True,
                                   ...
                                   value=app_model.tissue.damage_threshold, style={'margin':'20px 0px 20px 5px', 'padding':'0px 5px'}),
                         html.Label("Activation energy: ", htmlFor="activation_energy", style={'margin-left':'10px'}),
                         dcc.Input(id="activation_energy", type="number", debounce=True,
                                   ...
                                   value=app_model.tissue.activation_energy, style={'margin':'20px 0px 20px 5px', 'padding':'0px 5px'}),
                         html.Label(" J/mol", htmlFor="activation_energy"),
                         html.Label("Rate parameter: ", htmlFor="rate_parameter", style={'margin-left':'10px'}),
                         dcc.Input(id="rate_parameter", type="number", debounce=True,
                                   ...
                                   value=app_model.tissue.rate_parameter, style={'margin':'20px 0px 20px 5px', 'padding':'0px 5px'}),
